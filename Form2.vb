...
Public Class FrmSettings
    ...
    Public Sub FrmSettingStartUp()
        ...
        Dim voices = Form1.synth.GetInstalledVoices()
...
trypreviousimage:
    ...
    Private Sub Button38_Click(sender As System.Object, e As System.EventArgs) Handles BTNWICreateURL.Click
        ...
        Dim ImageBlogUrl As String = InputBox("Enter an image blog", "Image URL Generator", "http://(Blog Name).tumblr.com/")
...
Scrape:
        ...
        Catch ex As Exception
            MsgBox("That URL doesn't appear to be valid!", , "Error!")
        ...
        For Each node As XmlNode In doc.DocumentElement.SelectNodes("//photo-url")
            ...
            If node.Attributes.ItemOf("max-width").InnerText = 1280 Then
                ...
                If DupeList.Contains(node.InnerXml) Or DislikeList.Contains(node.InnerXml) Then
...
ExitScrape:
    ...
    Private Sub CBMetronome_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles CBMetronome.MouseClick

        If CBMetronome.Checked = False Then
            Form1.SP1.BackColor = Color.SteelBlue
            Form1.SP2.BackColor = Color.SteelBlue
            Form1.SP3.BackColor = Color.SteelBlue
            Form1.SP4.BackColor = Color.SteelBlue
            Form1.SP5.BackColor = Color.SteelBlue
            Form1.SP6.BackColor = Color.SteelBlue
            Form1.SP7.BackColor = Color.SteelBlue
            Form1.SP8.BackColor = Color.SteelBlue
            Form1.SP9.BackColor = Color.SteelBlue
            Form1.SP10.BackColor = Color.SteelBlue
        End If

        If CBMetronome.Checked = True Then
            My.Settings.CBMetronome = True
        Else
            My.Settings.CBMetronome = False
        End If
        My.Settings.Save()
    ...
    Private Sub CBMetronome_CheckedChanged_1(sender As System.Object, e As System.EventArgs) Handles CBMetronome.MouseHover
